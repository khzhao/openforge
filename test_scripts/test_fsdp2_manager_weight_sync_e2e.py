    ...
    try:
        ...
        for mode_index, mode in enumerate(SYNC_MODES, start=1):
            ...
            train_manager.sync_rollout_weights(
                policy_version=args.base_policy_version + mode_index,
